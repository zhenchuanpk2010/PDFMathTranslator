...
<h4 id="sop">1. 工作流程</h4>
   ...
   - 如果您的 PR 未通過自動檢查（顯示為 `checks failed` 和紅色叉號），請查看對應的 `details` 並修改您的提交內容，以確保新的 PR 能通過所有檢查。
...
<h4 id="docupdate">5. 文件更新</h4>
   ...
   - 如果您新增了命令行選項，請相應地更新所有語言版本的 `README.md` 檔案中的命令行選項列表。
