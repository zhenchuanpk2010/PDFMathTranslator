...
3. Probleme, die ausdrücklich als "Keine Hilfe benötigt" markiert sind (einschließlich Probleme im [Byaidu/PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate/issues) Repository).
