...
> - Die Version ohne Assets lädt Ressourcen beim Ausführen ebenfalls dynamisch herunter, aber der Download kann aufgrund von Netzwerkproblemen fehlschlagen.
...
***Schritt 4*** | Nach dem Doppelklicken auf die .exe-Datei öffnet sich ein Terminal. Nach etwa einer halben bis einer Minute öffnet sich automatisch eine Webseite in Ihrem Standardbrowser. Falls dies nicht geschieht, können Sie versuchen, manuell auf `http://localhost:7860/` zuzugreifen.
