...
- [Bereitstellung als öffentliche Dienste](#bereitstellung-als-öffentliche-dienste)
...
| `--<Services>`                  | Verwenden Sie [**spezifischen Dienst**](./Documentation-of-Translation-Services.md) für die Übersetzung | `pdf2zh example.pdf --openai`<br>`pdf2zh example.pdf --deepseek`                                                     |
...
| `--debug`                       | Debug-Protokollierungsstufe verwenden                                                                | `pdf2zh example.pdf --debug`                                                                                         |
...
| `--no-dual`                     | Geben Sie keine zweisprachigen PDF-Dateien aus                                                      | `pdf2zh example.pdf --no-dual`                                                                                       |
...
- Konfiguration über **Kommandozeilenargumente** ändern
...
Sie können das `--` in Kommandozeilenargumenten durch `PDF2ZH_` ersetzen, Parameter mit `=` verbinden und `-` durch `_` als Umgebungsvariablen ersetzen.
...
> - Die Konfigurationsdateien im `default`-Verzeichnis werden automatisch vom Programm generiert. Sie können sie zur Modifikation kopieren, aber bitte ändern Sie sie nicht direkt.
...
Wenn dieser Parameter auf True gesetzt wird, wird der Schritt zur Bereinigung der PDF übersprungen, was die Kompatibilität verbessern und einige Probleme bei der Schriftverarbeitung vermeiden kann.
...
#### Bereitstellung als öffentliche Dienste
