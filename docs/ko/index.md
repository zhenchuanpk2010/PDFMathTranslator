...
PDFMathTranslate is a tool that can translate PDF files while preserving the original layout and mathematical formulas.</p>

<p>It supports multiple languages and can be used via command line or web interface.</p>

<h3 id="features">Features</h3>

<ul>
<li>Preserve the original layout and mathematical formulas</li>
<li>Support multiple languages</li>
<li>Command line and web interface</li>
</ul>

<h3 id="installation">Installation</h3>

<p>You can install PDFMathTranslate via pip:</p>

<pre><code>pip install pdf2zh
</code></pre>

<h3 id="usage">Usage</h3>

<p>To translate a PDF file, run the following command:</p>

<pre><code>pdf2zh -i input.pdf -o output.pdf -t zh
</code></pre>

<p>For more details, see the [Usage](#usage) section.</p>

<h3 id="supported-languages">Supported Languages</h3>

<p>PDFMathTranslate supports the following languages:</p>
...
<p>Join our community to get help and share your feedback:</p>

<ul>
<li>[GitHub](https://github.com/pdf2zh)</li>
<li>[Discord](https://discord.gg/pdf2zh)</li>
</ul>

<h3 id="faq">FAQ</h3>

<p>For common questions, see the [FAQ](#faq) section.</p>

---

<h2 id="제목">PDFMathTranslate</h2>

<p>PDFMathTranslate 는 원본 레이아웃과 수학 공식을 유지하면서 PDF 파일을 번역할 수 있는 도구입니다.</p>

<p>여러 언어를 지원하며 명령줄 또는 웹 인터페이스를 통해 사용할 수 있습니다.</p>

<h3 id="기능">기능</h3>

<ul>
<li>원본 레이아웃과 수학 공식 유지</li>
<li>여러 언어 지원</li>
<li>명령줄 및 웹 인터페이스</li>
</ul>
...
<p>pip 를 통해 PDFMathTranslate 를 설치할 수 있습니다:</p>
...
<p>PDF 파일을 번역하려면 다음 명령을 실행하세요:</p>

<pre><code>pdf2zh -i input.pdf -o output.pdf -t zh
</code></pre>

<p>자세한 내용은 [사용법](#사용법) 섹션을 참조하세요.</p>

<h3 id="지원 - 언어">지원 언어</h3>

<p>PDFMathTranslate 는 다음 언어를 지원합니다:</p>
...
<p>도움을 받고 피드백을 공유하려면 커뮤니티에 참여하세요:</p>
...
<p>일반적인 질문은 [자주 묻는 질문](#자주 - 묻는 - 질문) 섹션을 참조하세요.</p>
  <!-- PyPI -->
