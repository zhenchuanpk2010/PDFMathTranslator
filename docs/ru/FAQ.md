Некоторые вопросы задаются часто, поэтому мы предоставили список для пользователей, которые сталкиваются с похожими проблемами.
...
- **Проблема**:
При выполнении программы пользователи могут получить следующие сообщения: `Следующие файлы не существуют: example.pdf`, если документ не был найден.
