...
<!-- CHUNK ID: h_rule_7c52396f  CHUNK TYPE: h_rule START_LINE:3 -->
---
...
<!-- CHUNK ID: h_rule_9c3d96a5  CHUNK TYPE: h_rule START_LINE:25 -->
---
...
<!-- CHUNK ID: chunk_85EA2B26  CHUNK TYPE: longtable_content START_LINE:82 -->
...
<!-- CHUNK ID: h_rule_e96006dc  CHUNK TYPE: h_rule START_LINE:99 -->
---
...
<!-- CHUNK ID: h_rule_b556df8f  CHUNK TYPE: h_rule START_LINE:157 -->
---
...
<!-- CHUNK ID: h_rule_02fbd1e0  CHUNK TYPE: h_rule START_LINE:197 -->
---
...
<!-- CHUNK ID: h_rule_2d8ee0fa  CHUNK TYPE: h_rule START_LINE:209 -->
---
...
<!-- CHUNK ID: h_rule_1b22b85b  CHUNK TYPE: h_rule START_LINE:227 -->
---
...
<!-- CHUNK ID: h_rule_9611b85a  CHUNK TYPE: h_rule START_LINE:241 -->
---
...
<!-- CHUNK ID: chunk_7D254F0A  CHUNK TYPE: image START_LINE:276 -->
...
<!-- CHUNK ID: h_rule_90fc1dde  CHUNK TYPE: h_rule START_LINE:302 -->
---
...
<!-- CHUNK ID: h_rule_b1b08196  CHUNK TYPE: h_rule START_LINE:323 -->
---
...
<!-- CHUNK ID: h_rule_5d0dcc3a  CHUNK TYPE: h_rule START_LINE:335 -->
---
...
<!-- CHUNK ID: chunk_9F68F89E  CHUNK TYPE: blockquote START_LINE:341 -->
> [!TIP]
...
<!-- CHUNK ID: chunk_F2D0AEC1  CHUNK TYPE: paragraph START_LINE:345 -->
A usable configuration is as follows:

<!-- CHUNK ID: chunk_12A9803B  CHUNK TYPE: code_block START_LINE:347 -->
...
<!-- CHUNK ID: chunk_F1B6ECA2  CHUNK TYPE: paragraph START_LINE:357 -->
[⬆️ Back to top](#toc)

<!-- CHUNK ID: h_rule_0c3406fd  CHUNK TYPE: h_rule START_LINE:359 -->
---

<!-- CHUNK ID: chunk_E255AB78  CHUNK TYPE: header START_LINE:361 -->
#### Authentication and welcome page

<!-- CHUNK ID: chunk_1A5EEA9C  CHUNK TYPE: paragraph START_LINE:363 -->
...
<!-- CHUNK ID: chunk_B865D3B8  CHUNK TYPE: code_block START_LINE:368 -->
```
admin,123456
user1,password1
user2,abc123
...
<!-- CHUNK ID: chunk_0CEA118C  CHUNK TYPE: paragraph START_LINE:376 -->
example welcome.html

<!-- CHUNK ID: chunk_0FC66A15  CHUNK TYPE: code_block START_LINE:378 -->
```html
<!DOCTYPE html>
<html>
<head>
...
<!-- CHUNK ID: chunk_40E12FA3  CHUNK TYPE: blockquote START_LINE:391 -->
> [!NOTE]
...
<!-- CHUNK ID: chunk_F2D0AEC1  CHUNK TYPE: paragraph START_LINE:395 -->
A usable configuration is as follows:

<!-- CHUNK ID: chunk_39D7C203  CHUNK TYPE: code_block START_LINE:397 -->
```toml title="config.toml"
[basic]
gui = true
...
<!-- CHUNK ID: chunk_F1B6ECA2  CHUNK TYPE: paragraph START_LINE:406 -->
[⬆️ Back to top](#toc)

<!-- CHUNK ID: h_rule_d5640724  CHUNK TYPE: h_rule START_LINE:408 -->
---

<!-- CHUNK ID: chunk_4A9C44BF  CHUNK TYPE: header START_LINE:410 -->
#### Glossary Support

<!-- CHUNK ID: chunk_65580DD5  CHUNK TYPE: paragraph START_LINE:412 -->
...
<!-- CHUNK ID: chunk_2403CA4A  CHUNK TYPE: table START_LINE:415 -->
...
<!-- CHUNK ID: chunk_598725B0  CHUNK TYPE: paragraph START_LINE:422 -->
For CLI user:
You can use multiple files for glossary. And different files should be split by `,`.

<!-- CHUNK ID: chunk_332A0BF8  CHUNK TYPE: code_block START_LINE:425 -->
```bash
pdf2zh_next example.pdf --glossaries "glossary1.csv,glossary2.csv,glossary3.csv"
```

<!-- CHUNK ID: chunk_B3174CBC  CHUNK TYPE: paragraph START_LINE:429 -->
For WebUI user:
